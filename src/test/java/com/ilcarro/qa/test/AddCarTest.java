    ...
    public void testFormLetTheCarWorkLoggedInUser() throws InterruptedException {
        ...
        if (!app.getUser().userLoggedIn()) {
            ...
            app.getCar().fillCarForm(new Car()
                    .withCountry("Israel").withAddress("Balfur Street")
                    .withDistanceIncluded("500").withSerialNumber("123 45 671")
                    .withBrand("Volkswagen").withModel("Polo")
                    .withYear("2010")
                    .withEngine("V6")
                    .withFuel_consumption("8").withFuel("Super")
                    .withTransmission("automatic")
                    .withWd("4WD")
                    .withHorsePower("250")
                    .withTorque("150").withDoors("2")
                    .withSeats("2").withCarClass("B")
                    .withAbout("I am a super driver")
                    .withTypeFeature("Red color").withPrice("100"));
